...
void aboutScreen()
{
  ...
  OledShowString(20,4,(char *)("Ver:" FIRMWARE_VERSION),8);
  OledShowString(20,5,(char *)("2024.9"),8);
  OledShowString(20,6,(char *)("HDR/t-chamb"),8);
...
uint8_t gbxMenu() 
{
  soft_uart_send_string("gbxMenu: entered\r\n");
  //
  uint8_t bret = 0;
  uint8_t gbxtype = GetGBType();
  char type_msg[32];
  sprintf(type_msg, "Cart type detected: %d\r\n", gbxtype);
  soft_uart_send_string(type_msg);
  ...
  if(gbxtype == TYPE_GBA)
  {
    ...
    switch (gbType)
    {
      case 0:
        ...
        break;
      case 1:
        soft_uart_send_string("Entering gbaScreen()\r\n");
        gbaScreen();
        break;
      case 2:
        //
  ...
  else if(gbxtype == TYPE_GBC)
  {
    ...
    switch (gbType)
    {
      case 0:
        ...
        break;
      case 1:
        soft_uart_send_string("Entering gbScreen()\r\n");
        gbScreen();
        break;
      case 2:
        //
  ...
  {
    soft_uart_send_string("No cartridge detected - showing menu\r\n");
    gbType = questionBox_OLED("Portable Cart Flasher", menuOptionsGBx, 2, 1, 1, 1);
    soft_uart_send_string("questionBox_OLED returned\r\n");
...
void gbxScreen()
{
  soft_uart_send_string("gbxScreen: entered\r\n");
  while(1)
  {
    //
    soft_uart_send_string("gbxScreen: calling gbxMenu\r\n");
    uint8_t b = gbxMenu();
    soft_uart_send_string("gbxScreen: gbxMenu returned\r\n");
    
    if(b>0)break;
  }
  soft_uart_send_string("gbxScreen: exiting\r\n");
}
...
void SDCardInit()
{
  ...
  soft_uart_send_string("SDCardInit: Starting\r\n");
  ...
  soft_uart_send_string("SDCardInit: sd_io_init done\r\n");
  ...
  if(i){
      ...
      soft_uart_send_string("SDCardInit: SD Card init failed!\r\n");
      // Don't reset on SD card failure - continue anyway
      SD_Status = sd_error;
      soft_uart_send_string("SDCardInit: Continuing without SD card\r\n");
  }
  
  soft_uart_send_string("SDCardInit: Before card_info_get\r\n");
  
  /* get the information of the card and print it out by USART */
  card_info_get();

  soft_uart_send_string("SDCardInit: Before f_mount\r\n");
  ...
  else if(res_sd!=FR_OK)
  {
          ...
          soft_uart_send_string("WARNING: SD mount failed, continuing anyway\r\n");
  }
  else
  {
          printf("\r\nMount OK!%d\r\n",res_sd);
  ...
  soft_uart_send_string("SDCardInit: Complete\r\n");
}
...
int main(void) 
{
  ...
  // Initialize PA13/PA14 UART
  soft_uart_init();
  soft_uart_send_string("\r\nBurnmaster v" FIRMWARE_VERSION " UART\r\n");
  soft_uart_send_string("main: Entered main function\r\n");
  
  //
  LEDSInit();
  soft_uart_send_string("LED init OK\r\n");
  
  //test();
  OledInit();
  soft_uart_send_string("OLED init OK\r\n");
  
  OledClear();
  KeyBrdInit();
  soft_uart_send_string("Keyboard init OK\r\n");
  
  soft_uart_send_string("main: About to call SDCardInit\r\n");
  SDCardInit();
  soft_uart_send_string("main: SDCardInit returned\r\n");

  soft_uart_send_string("About to delay...\r\n");
  soft_uart_send_string("Delay starting now\r\n");
  ...
  // Test delay
  delay(200);
  soft_uart_send_string("Delay complete\r\n");
  soft_uart_send_string("Starting gbxScreen\r\n");
  gbxScreen();
  soft_uart_send_string("gbxScreen returned\r\n");
